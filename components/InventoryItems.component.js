...
import { removeItem } from '../redux/actions/inventoryActions';
class InventoryItems extends Component {    state = {
        activeRowKey: null
    }    
    render() {
        const swipeSettings = {
...
export default connect(null,{removeItem})(InventoryItems);